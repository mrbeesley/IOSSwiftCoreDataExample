...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func getFirstViewController() -> ShoutOutDraftsViewController {
        ...
        // Get the windows root view controller (which is a navigation controller)
        let navigationController = window?.rootViewController as! UINavigationController
        
        
        // Get the navigation controllers first view controller 
        let firstVC = navigationController.viewControllers[0]
        
        
        // Cast the controller to a shoutoutdraftsviewcontroller and then return it
